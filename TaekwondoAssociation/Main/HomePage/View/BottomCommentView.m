...
//            _shareBtn.backgroundColor = [UIColor blueColor];
        ...
        case 1:
            ...
            [_shareBtn setImage:[UIImage imageNamed:@"share"] forState:UIControlStateNormal];
            [_tagsBtn setImage:[UIImage imageNamed:@"likes-small"] forState:UIControlStateNormal];
            [_tagsBtn setImage:[UIImage imageNamed:@"likes-small-selected"] forState:UIControlStateSelected];
